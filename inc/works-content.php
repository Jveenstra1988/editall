...
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\-->
    ...
    <article class="bg-grijs3 content">
        ...
        <a href="img/works/com/color/route99-1.jpg" data-lightbox="jamie"><img src="img/works/com/color/route99-1.jpg" class="attribute"></a>
    ...
    <article class="bg-grijs3 content">
        ...
        <a href="img/works/com/color/popcorn2.jpg" data-lightbox="switch"><img src="img/works/com/color/popcorn2.jpg" class="attribute"></a>
...
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\-->
    ...
    <article class="bg-grijs3 content">
        ...
        <a href="img/works/std/color/jb-bbb1.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb1.jpg" class="attribute"></a>

        <a href="img/works/std/color/jb-bbb2.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb2.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb3.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb3.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb4.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb4.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb5.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb5.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb6.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb6.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb7.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb7.jpg" class="img-stack"></a>
        <a href="img/works/std/color/jb-bbb8.jpg" data-lightbox="jamie"><img src="img/works/std/color/jb-bbb8.jpg" class="img-stack"></a>
    </article>
</section>
...
<section class="bg-grijs2" id="jb-design">
    ...
    <article class="bg-grijs3 content">
        <h1 class="txt-zwart txt-left">Just Brands Design</h1>
        <p class="txt-zwart">
