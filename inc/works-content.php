...
<section class="bg-wit" id="just-brands">
	<article class="bg-wit">
		<a href="#" class="btn-zwart back-to-overzicht">Back</a>
		<h1>Just Brands</h1>
		<img src="img/projects/just-brands.jpg" class="attribute">
		<p>
			Op vrijdag 01 maart 2013 is de nieuwe Just Brands store
			geopend in Rotterdam. Onder veel aandacht is de nieuwe winkel
			van 300 m2 geopend met split level, eerste etage. Kom een keer
			kijken naar deze store van Just Brands op de Lijnbaan 97a in
			Rotterdam.<br>
			Edit-All is verantwoordelijk geweest voor de ontwerp,
			uitvoering en oplevering van dit gehele project.
		</p>
...
<section class="bg-wit" id="olli">
	<article class="bg-wit">
		<a href="#" class="btn-zwart back-to-overzicht">Back</a>
		<h1>Olli</h1>
		<img src="img/projects/olli.jpg" class="attribute">
		<p>
			Op vrijdag 01 maart 2013 is de nieuwe Just Brands store
			geopend in Rotterdam. Onder veel aandacht is de nieuwe winkel
			van 300 m2 geopend met split level, eerste etage. Kom een keer
		...
		<img src="img/projects/pme-shop-in-shop" class="">
	</article>
</section>
...
<section class="bg-wit" id="pme-shop">
	<article class="bg-wit">
		<a href="#" class="btn-zwart back-to-overzicht">Back</a>
		<h1>PME Shop in Shop</h1>
		<img src="http://placehold.it/100" class="attribute">
		<p>
			Op vrijdag 01 maart 2013 is de nieuwe Just Brands store
			geopend in Rotterdam. Onder veel aandacht is de nieuwe winkel
			van 300 m2 geopend met split level, eerste etage. Kom een keer
