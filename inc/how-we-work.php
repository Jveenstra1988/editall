<section class="bg-grijs2">
    ...
    <article class="bg-grijs3 content">
        ...
        <a href="img/works/how-we/gesprek.jpg" alt="Gesprek met edit-all" data-lightbox="jbs">
        ...
        <a href="img/works/how-we/schets.jpg" alt="Schetsen van onze ontwerpers" data-lightbox="jbs">
        ...
        <a href="img/works/how-we/3dtekening.jpg" alt="Het ontwerp van de 3D tekening" data-lightbox="jbs">
        ...
        <a href="img/works/how-we/eindresultaat.jpg" alt="Het eindresultaat" data-lightbox="jbs">
            <img src="img/works/how-we/eindresultaat.jpg" alt="Het eindresultaat" class="attribute">
        </a>
    </article>
</section>